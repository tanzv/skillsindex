# Prototype Page Scorecard (Admin Scope, Pass 2)
...
`mcp snapshot_layout (problemsOnly=true)` still shows clipping only on homepage containers:
...
| sNW38 | SkillsIndex / Sync and Export Command Center | dark | 92 | PASS | P3 | Stable | 0 | 33 | 1/1 | 0 |
...
| 9sq0k | SkillsIndex / Ingestion Center | dark | 93 | PASS | P3 | Stable | 0 | 13 | 1/1 | 0 |
...
| 4M0zx | SkillsIndex / Auth and DingTalk Journey Light | light | 94 | PASS | P3 | Light hierarchy may flatten in dense blocks | 0 | 2 | 0/0 | 2 |
...
| ReuoM | SkillsIndex / Job Orchestration Center | dark | 94 | PASS | P3 | Stable | 0 | 17 | 1/1 | 0 |
...
| Onzo0 | SkillsIndex / Sync Policy Management | dark | 94 | PASS | P3 | Stable | 0 | 18 | 1/1 | 0 |
| iTgm0 | SkillsIndex / Sync Policy Management Light | light | 94 | PASS | P3 | Stable | 0 | 31 | 1/1 | 0 |
| LCu0c | SkillsIndex / Sync Run Ledger | dark | 94 | PASS | P3 | Stable | 0 | 17 | 1/1 | 0 |
| r0yUw | SkillsIndex / Sync Run Ledger Light | light | 94 | PASS | P3 | Stable | 0 | 30 | 1/1 | 0 |
| 8fERA | SkillsIndex / Account Center Target | dark | 95 | PASS | P3 | Stable | 0 | 13 | 1/1 | 0 |
...
| phuBz | SkillsIndex / Records Governance | dark | 95 | PASS | P3 | Stable | 0 | 17 | 1/1 | 0 |
...
| 7WR7g | SkillsIndex / Ingestion SkillMP | dark | 96 | PASS | P3 | Stable | 0 | 13 | 1/1 | 0 |
...
1. P1/P2 backlog from the previous pass has been cleared under current scoring rules.
2. Remaining work should focus on micro-polish and preserving CTA discoverability while keeping low-noise panels.
