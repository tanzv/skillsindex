	...
	return map[string]any{
		...
		"SyncJobRunItem": map[string]any{
			...
			"properties": map[string]any{
				...
				"audit": map[string]any{
					...
					"properties": map[string]any{
						"total":              map[string]any{"type": "integer"},
						"job_audit_count":    map[string]any{"type": "integer"},
						"skill_audit_count":  map[string]any{"type": "integer"},
						"latest_action":      map[string]any{"type": "string"},
						"latest_target_type": map[string]any{"type": "string"},
						"latest_target_id":   map[string]any{"type": "integer"},
						"latest_created_at":  map[string]any{"type": "string", "format": "date-time"},
					},
				},
			},
		},
		"AsyncJobItem": map[string]any{
			...
			"properties": map[string]any{
				...
				"target_skill_id":     map[string]any{"type": "integer"},
				"sync_run_id":         map[string]any{"type": "integer"},
				"attempt":             map[string]any{"type": "integer"},
