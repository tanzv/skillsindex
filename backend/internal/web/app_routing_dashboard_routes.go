...
func (a *App) registerAdminAccessRoutes(r chi.Router) {
	...
	r.Get("/api/v1/admin/settings/category-catalog", a.handleAPIAdminCategoryCatalogSetting)
	r.Post("/api/v1/admin/settings/category-catalog", a.handleAPIAdminCategoryCatalogSettingUpdate)
	r.Get("/api/v1/admin/settings/presentation-taxonomy", a.handleAPIAdminPresentationTaxonomySetting)
	r.Post("/api/v1/admin/settings/presentation-taxonomy", a.handleAPIAdminPresentationTaxonomySettingUpdate)
	...
	r.Get("/api/v1/admin/auth-provider-configs", a.handleAPIAdminAuthProviderConfigs)
	r.Get("/api/v1/admin/auth-provider-configs/{provider}", a.handleAPIAdminAuthProviderConfigDetail)
	r.Post("/api/v1/admin/auth-provider-configs", a.handleAPIAdminAuthProviderConfigUpsert)
	r.Post("/api/v1/admin/auth-provider-configs/{provider}/disable", a.handleAPIAdminAuthProviderConfigDisable)
