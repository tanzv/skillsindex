...
export const publicSkillDetailFileTabsStyles = css`
  ...
  .skill-detail-top-file-browse {
    ...
    cursor: pointer;
    transition:
      color var(--skill-detail-motion-fast) var(--skill-detail-ease-standard),
      border-color var(--skill-detail-motion-fast) var(--skill-detail-ease-standard),
  ...
  .skill-detail-top-file-browse:hover {
    background: color-mix(in srgb, var(--skill-detail-surface-3) 80%, transparent);
    color: var(--skill-detail-text-primary);
    border-color: color-mix(in srgb, var(--skill-detail-border-strong) 74%, transparent);
    box-shadow: none;
  }
  ...
  .skill-detail-page.is-light .skill-detail-top-file-browse:hover {
    background: color-mix(in srgb, var(--skill-detail-surface-3) 76%, #ffffff 24%);
    color: var(--skill-detail-text-primary);
    border-color: color-mix(in srgb, var(--skill-detail-border-strong) 82%, #b9c6d5 18%);
  }
