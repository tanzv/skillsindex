  ...
  it("keeps key geometry and palette values synchronized with hEu3i", () => {
    ...
    expect(
      publicSkillDetailThemeStyles.styles.includes("height: 86px") ||
        ...
        publicSkillDetailThemeStyles.styles.includes("min-height: 104px")
    ).toBe(true);
    expect(
    ...
    expect(
      publicSkillDetailThemeStyles.styles.includes("width: 444px") ||
        ...
        publicSkillDetailThemeStyles.styles.includes("grid-template-columns: minmax(0, 1fr) minmax(328px, 380px)")
    ).toBe(true);
    expect(
      publicSkillDetailThemeStyles.styles.includes("height: 176px") ||
        publicSkillDetailThemeStyles.styles.includes("min-height: 0")
    ).toBe(true);
    expect(
      publicSkillDetailThemeStyles.styles.includes("height: 470px") ||
        ...
        publicSkillDetailThemeStyles.styles.includes("min-height: 500px")
    ).toBe(true);
    ...
    expect(
      publicSkillDetailThemeStyles.styles.includes("background: #242424") ||
        publicSkillDetailThemeStyles.styles.includes("background: color-mix(in srgb, var(--skill-detail-surface-1) 88%, var(--skill-detail-surface-2) 12%)")
    ).toBe(true);
    expect(
      publicSkillDetailThemeStyles.styles.includes("border-radius: 16px") ||
        publicSkillDetailThemeStyles.styles.includes("border-radius: 14px")
    ).toBe(true);
    ...
    expect(
      publicSkillDetailThemeStyles.styles.includes("height: 44px;") ||
        publicSkillDetailThemeStyles.styles.includes("height: 42px;")
    ).toBe(true);
